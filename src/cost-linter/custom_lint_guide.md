...
The authoritative, up-to-date guide for adding a new lint to `soroban-cost-linter` is **[`DEVELOPING_LINTS.md`](https://github.com/Tollcraft/soroban-cost-linter/blob/main/DEVELOPING_LINTS.md)** at the repository root (also at [`DEVELOPING_LINTS.md` on GitHub](https://github.com/Tollcraft/soroban-cost-linter/blob/main/DEVELOPING_LINTS.md)).
