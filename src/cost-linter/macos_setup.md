...
This page complements [`CONTRIBUTING.md`](https://github.com/Tollcraft/soroban-cost-linter/blob/main/CONTRIBUTING.md) with macOS-specific setup instructions for `soroban-cost-linter`.
