...
The nightly channel is declared once in [`rust-toolchain`](https://github.com/Tollcraft/soroban-cost-linter/blob/main/rust-toolchain). This is the source of truth. All other files—workflows, templates, documentation—should reflect this same date.
...
Open [`rust-toolchain`](https://github.com/Tollcraft/soroban-cost-linter/blob/main/rust-toolchain) and update the `channel` field:
...
Open [`soroban_cost_lints/Cargo.toml`](https://github.com/Tollcraft/soroban-cost-linter/blob/main/soroban_cost_lints/Cargo.toml) and update the `clippy_utils` dependency:
...
Update the example in [`docs/integration.md`](/cost-linter/integration):
